...
<p align="center">
  <a href="#why-openblur-exists">Why This Exists</a> &middot;
...
The code actually works. `npm install`, `npx remotion render`, you get a video. The Remotion components are real React/CSS. The ElevenLabs and MusicGen integrations are real. The [evolution from AI-generated screenshots to Remotion](#how-it-was-built) is a real case study in knowing when to use AI and when not to.
...
> For the full technical deep dive with pipeline diagrams, see [docs/EVOLUTION.md](docs/EVOLUTION.md).
